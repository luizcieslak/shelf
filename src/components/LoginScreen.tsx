...
const LoginScreen = observer(() => {
	...
	return (
		<div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center p-4'>
			<div className='max-w-md w-full space-y-8 bg-white p-8 rounded-xl shadow-lg animate-scale-in'>
				<div className='text-center'>
					<h2 className='text-3xl font-bold text-gray-900 animate-fade-in'>Shelf</h2>
				</div>
				...
				<div className='space-y-4'>
					...
					>
						...
						<p className='w-[141px] text-center'>
					...
					>
						...
						<p className='w-[141px] text-center'>Connect Apple Music</p>
						<span className='absolute -top-1 -right-1 bg-orange-500 text-white text-xs px-1.5 py-0.5 rounded-full'>
							Soon
						</span>
					</button>

					<p className='text-center text-sm text-gray-500 stagger-item' style={{ animationDelay: '300ms' }}>
